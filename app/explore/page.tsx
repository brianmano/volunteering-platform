    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-card border-b border-border">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4 text-balance">Discover Volunteer Opportunities</h1>
      ...
      <section className="container mx-auto px-4 py-8">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-2 pt-2">
                  {position.applyOnSite ? (
                    ...
                    <a href={position.applicationUrl} target="_blank" rel="noopener noreferrer" className="flex-1">
        ...
        {filteredPositions.length === 0 && (
          <Card className="p-12 text-center">
            <p className="text-muted-foreground mb-4">No positions found matching your criteria</p>
            <Button onClick={handleReset} variant="outline">
              Clear Filters
            </Button>
          </Card>
